...
const About = () => {
  ...
  const secondSection = sections && sections.length > 1 ? sections[1] : null;
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex justify-between items-center gap-8 mt-4 h-12">
            <div>
              {firstSection && (
                <a
                  href={firstSection.href}
                  className="text-4xl font-bold text-left text-white"
                >
          ...
          <div className="flex items-center justify-center mt-20 gap-x-8">
            <a
              aria-label="github"
